...
echo "$($PSQL "SELECT major FROM majors FULL JOIN students ON students.major_id=majors.major_id WHERE student_id IS NULL OR first_name ILIKE '%ma%' ORDER BY major")"
